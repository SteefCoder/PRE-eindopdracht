...
window.onload = () => {
    chart = create_chart(
        ['Vatbaar', 'Latente tbc', 'Besmettelijke tbc', 'Genezen'],
    ...
    create_input_slider("r1", "r1", "Het deel van de groep met latente tbc dat per jaar geneest. Dit is in India slechts 0.01% omdat mensen met latente tbc ook geen symptomen hebben en het dus vaak niet wordt opgemerkt.");
    ...
    create_input_slider("k", "k", "Het deel van de groep met latente tbc dat per jaar symptomen krijgt en dus besmettelijk wordt. Dat is zo'n 8.3% van de mensen met latente tbc per jaar. Ongeveer 2.5% van de bevolking in India heeft tbc in de latente vorm, terwijl maar 0.32% besmettelijke tbc heeft.");
    set_defaults();
